...
BOOST_AUTO_TEST_CASE(normalize_capitals) {
  BOOST_REQUIRE_EQUAL("hello",
                      crypto_square::cipher("Hello").normalize_plain_text());
}

BOOST_AUTO_TEST_CASE(normalize_spaces) {
  BOOST_REQUIRE_EQUAL("hithere",
...
BOOST_AUTO_TEST_CASE(plain_text_segments_from_phrase) {
  ...
  const auto actual = crypto_square::cipher(
...
BOOST_AUTO_TEST_CASE(cipher_text_empty_phrase) {
  BOOST_REQUIRE_EQUAL("", crypto_square::cipher("").cipher_text());
}
...
BOOST_AUTO_TEST_CASE(normalized_cipher_text_empty) {
  BOOST_REQUIRE_EQUAL("", crypto_square::cipher("").normalized_cipher_text());
}
