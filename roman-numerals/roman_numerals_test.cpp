...
TEST_CASE("two_yields_II") { REQUIRE("II" == roman_numerals::convert(2)); }

TEST_CASE("three_yields_III") { REQUIRE("III" == roman_numerals::convert(3)); }

TEST_CASE("four_yields_IV") { REQUIRE("IV" == roman_numerals::convert(4)); }

TEST_CASE("five_yields_V") { REQUIRE("V" == roman_numerals::convert(5)); }

TEST_CASE("six_yields_VI") { REQUIRE("VI" == roman_numerals::convert(6)); }

TEST_CASE("nine_yields_IX") { REQUIRE("IX" == roman_numerals::convert(9)); }
